...
def generate_test_data(output_dir="data/raw", num_months=24):
    ...
    # Save with the expected filename from config
    who_filename = "Ch11-Nutrition-Figures.xlsx"  # Expected by config
    ...
    # Save with the expected filename from config
    unicef_filename = "JMP_2021_INEQUALITIES_KEN_Kenya_1.xlsm"  # Expected by config
    ...
    # Save with the expected filename from config
    dhis2_filename = "metadata-nutrition-indicators-for-kenya.csv"  # Expected by config
